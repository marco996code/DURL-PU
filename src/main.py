...
if __name__ == "__main__":
    ...
    # mem_features, mem_labels = extract_features(global_model, self.memory_loader)
    ...
    if args.optimizer == "adam":
        ...
        optimizer = torch.optim.SGD(global_model.parameters(), lr=train_lr, momentum=0.9, weight_decay=1e-4)
