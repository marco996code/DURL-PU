...
def args_parser():
    ...
    # other arguments
    parser.add_argument("--dataset", type=str, default="fairssl", help="name of dataset")
    parser.add_argument(
    ...
    parser.add_argument(
        "--iid", type=int, default=1, help="Default set to IID. Set to 0 for non-IID."# I think Set to 1 for non-IID.
    )
    ...
    parser.add_argument(
        "--ssl_method", type=str, default="pu", help="simclr, byol, simsiam, orch"
    )
    parser.add_argument(
        "--x_noniid", action="store_true", help="non i.i.d x distribution"
    )
    parser.add_argument(
        "--dirichlet", action="store_true", default=False, help="dirichlet label distribution"
    )
    parser.add_argument(
        "--test_intermediate", action="store_true", help="dirichlet label distribution"
    )
    parser.add_argument(
        "--dir_beta", type=float, default=0.02, help="Dirichlet Parameters"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--y_partition_skew", action="store_true", default="True", help="use skew partition for y label"
    )
    parser.add_argument(
        "--y_partition_ratio",
        type=float,
    ...
    parser.add_argument("--nor", type=int, default=1, help="set 1 reprenset use normalization in train")
    parser.add_argument("--use_new_transform", type=int, default=2, help="set 1 reprenset use normalization in train")
